...
5. Do not manually install Python, pip, `requests`, Homebrew, or a Release ZIP. On first invocation, `scripts/h_run.cmd` or `scripts/h_run.sh` automatically obtains the verified runtime for the current operating system when necessary.
